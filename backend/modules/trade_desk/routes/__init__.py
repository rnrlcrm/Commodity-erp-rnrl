...
- GET /availabilities/search - AI-powered smart search
- GET /availabilities/my - Get seller's inventory
- GET /availabilities/{id} - Get availability by ID
- PUT /availabilities/{id} - Update availability
- POST /availabilities/{id}/approve - Approve availability
- POST /availabilities/{id}/reserve - Reserve quantity (internal API)
- POST /availabilities/{id}/release - Release quantity (internal API)
- POST /availabilities/{id}/mark-sold - Mark as sold (internal API)
- GET /availabilities/{id}/negotiation-score - Get negotiation readiness
- GET /availabilities/{id}/similar - Get similar commodities
"""
...
from backend.api.v1.dependencies.database import get_db
...
async def get_current_seller_id() -> UUID:
    """Placeholder for seller context."""
    return UUID("00000000-0000-0000-0000-000000000001")


async def get_current_buyer_id() -> UUID:
    """Placeholder for buyer context."""
